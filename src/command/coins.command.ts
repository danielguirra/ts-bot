...
export class CoinsCommand extends SlashCommandBuilder {
   constructor() {
      super();
      this.setName('moedas').setDescription('lista de moedas');
   }
   ...
   private coins = `  AED	Dirham dos Emirados Árabes Unidos
