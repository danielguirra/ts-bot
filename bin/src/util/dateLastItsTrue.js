...
exports.dateLastItsTrue = void 0;
function dateLastItsTrue(lastMessageChannelClimate) {
    const dateLastMessageChannelClimate = new Date(lastMessageChannelClimate.createdTimestamp);
    ...
    if (dateLastMessageChannelClimateObjc.day < dateFromNow.day &&
